...
public class AutoMainCmd extends SequentialCommandGroup {
    ...
    private static double jagabeeThing = -((m_vision.getJagabee(0)-160) * 0.085/295);
    private static double dettolXMove = ((m_vision.getDettol(0) -160) * 0.1/100);
    ...
    public AutoMainCmd() {
        ...
        super(
            new MoveArm(new Translation2d(0.16,0.38), 50),
            new WaitCommand(5),
            new AlignPicker(1)
            //new MoveRobot(0, dettolXMove , 0, 0, 0.5)
               ...
               // new AlignRobot()
                ...
                // new MoveRobotSense(1,5,0,0,0.05, () -> m_sensor.getIRDistance() <15)
    ...
    public void initialize() {
        ...
        jagabeeThing = -((m_vision.getJagabee(0)-160) * 0.085/295);
        dettolXMove = ((m_vision.getDettol(0)-160) * 0.1/100);
